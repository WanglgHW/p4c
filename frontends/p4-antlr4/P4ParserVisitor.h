...
public:
   ...
   */
    ...
    virtual std::any visitAnnExpressionList(P4Parser::AnnExpressionListContext *context) = 0;

    virtual std::any visitAnnKvList(P4Parser::AnnKvListContext *context) = 0;

    virtual std::any visitAnnIntegerList(P4Parser::AnnIntegerListContext *context) = 0;

    virtual std::any visitAnnIntOrStrList(P4Parser::AnnIntOrStrListContext *context) = 0;

    virtual std::any visitAnnStringList(P4Parser::AnnStringListContext *context) = 0;

    virtual std::any visitAnnExpression(P4Parser::AnnExpressionContext *context) = 0;

    virtual std::any visitAnnInteger(P4Parser::AnnIntegerContext *context) = 0;

    virtual std::any visitAnnIntOrStr(P4Parser::AnnIntOrStrContext *context) = 0;

    virtual std::any visitAnnStringLiteral(P4Parser::AnnStringLiteralContext *context) = 0;

    virtual std::any visitAnnExpressionPair(P4Parser::AnnExpressionPairContext *context) = 0;

    virtual std::any visitAnnIntegerPair(P4Parser::AnnIntegerPairContext *context) = 0;

    virtual std::any visitAnnStringPair(P4Parser::AnnStringPairContext *context) = 0;

    virtual std::any visitAnnExpressionTriple(P4Parser::AnnExpressionTripleContext *context) = 0;

    virtual std::any visitAnnIntegerTriple(P4Parser::AnnIntegerTripleContext *context) = 0;

    virtual std::any visitAnnStringTriple(P4Parser::AnnStringTripleContext *context) = 0;

    virtual std::any visitAnnP4rtTranslation(P4Parser::AnnP4rtTranslationContext *context) = 0;

    virtual std::any visitIntOrStr(P4Parser::IntOrStrContext *context) = 0;

    virtual std::any visitP4rtControllerType(P4Parser::P4rtControllerTypeContext *context) = 0;
