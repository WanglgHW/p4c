...
// Alias the ANTLR4-generated P4Parser (global namespace) to avoid ambiguity
// with the Bison-generated P4::P4Parser when both headers are included.
using Antlr4P4Parser = ::P4Parser;

namespace P4ANTLR {

/// Visits the ANTLR4 parse tree and constructs p4c IR nodes.
/// This mirrors the semantic actions in p4parser.ypp.
