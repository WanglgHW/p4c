...
/// Map an ANTLR4 token type to the corresponding Bison P4Parser token type.
/// This is needed for annotation body tokens which get re-parsed by the
/// Bison-based annotation parser.
static int antlr4ToBisonTokenType(size_t antlr4Type) {
    using A = ::P4Lexer;
    using B = P4::P4Parser::token_type;
    switch (antlr4Type) {
        // Keywords
        case A::ABSTRACT: return B::TOK_ABSTRACT;
        case A::ACTION: return B::TOK_ACTION;
        case A::ACTIONS: return B::TOK_ACTIONS;
        case A::APPLY: return B::TOK_APPLY;
        case A::BOOL: return B::TOK_BOOL;
        case A::BIT: return B::TOK_BIT;
        case A::BREAK: return B::TOK_BREAK;
        case A::CONST: return B::TOK_CONST;
        case A::CONTINUE: return B::TOK_CONTINUE;
        case A::CONTROL: return B::TOK_CONTROL;
        case A::DEFAULT: return B::TOK_DEFAULT;
        case A::ELSE: return B::TOK_ELSE;
        case A::ENTRIES: return B::TOK_ENTRIES;
        case A::ENUM: return B::TOK_ENUM;
        case A::ERROR: return B::TOK_ERROR;
        case A::EXIT: return B::TOK_EXIT;
        case A::EXTERN: return B::TOK_EXTERN;
        case A::FALSE: return B::TOK_FALSE;
        case A::FOR: return B::TOK_FOR;
        case A::HEADER: return B::TOK_HEADER;
        case A::HEADER_UNION: return B::TOK_HEADER_UNION;
        case A::IF: return B::TOK_IF;
        case A::IN: return B::TOK_IN;
        case A::INOUT: return B::TOK_INOUT;
        case A::INT: return B::TOK_INT;
        case A::KEY: return B::TOK_KEY;
        case A::LIST: return B::TOK_LIST;
        case A::MATCH_KIND: return B::TOK_MATCH_KIND;
        case A::TYPE: return B::TOK_TYPE;
        case A::OUT: return B::TOK_OUT;
        case A::PACKAGE: return B::TOK_PACKAGE;
        case A::PARSER: return B::TOK_PARSER;
        case A::PRIORITY: return B::TOK_PRIORITY;
        case A::RETURN: return B::TOK_RETURN;
        case A::SELECT: return B::TOK_SELECT;
        case A::STATE: return B::TOK_STATE;
        case A::STRING_KW: return B::TOK_STRING;
        case A::STRUCT: return B::TOK_STRUCT;
        case A::SWITCH: return B::TOK_SWITCH;
        case A::TABLE: return B::TOK_TABLE;
        case A::THIS: return B::TOK_THIS;
        case A::TRANSITION: return B::TOK_TRANSITION;
        case A::TRUE: return B::TOK_TRUE;
        case A::TUPLE: return B::TOK_TUPLE;
        case A::TYPEDEF: return B::TOK_TYPEDEF;
        case A::VARBIT: return B::TOK_VARBIT;
        case A::VALUE_SET: return B::TOK_VALUESET;
        case A::VOID: return B::TOK_VOID;
        // Operators
        case A::LEQ: return B::TOK_LE;
        case A::GEQ: return B::TOK_GE;
        case A::SHL: return B::TOK_SHL;
        case A::LOG_AND: return B::TOK_AND;
        case A::LOG_OR: return B::TOK_OR;
        case A::NEQ: return B::TOK_NE;
        case A::EQ: return B::TOK_EQ;
        case A::PLUS: return B::TOK_PLUS;
        case A::MINUS: return B::TOK_MINUS;
        case A::PLUS_SAT: return B::TOK_PLUS_SAT;
        case A::MINUS_SAT: return B::TOK_MINUS_SAT;
        case A::MUL: return B::TOK_MUL;
        case A::INVALID_TOK: return B::TOK_INVALID;
        case A::DIV: return B::TOK_DIV;
        case A::MOD: return B::TOK_MOD;
        case A::BIT_OR: return B::TOK_BIT_OR;
        case A::BIT_AND: return B::TOK_BIT_AND;
        case A::BIT_XOR: return B::TOK_BIT_XOR;
        case A::BIT_NOT: return B::TOK_COMPLEMENT;
        case A::LBRAK: return B::TOK_L_BRACKET;
        case A::RBRAK: return B::TOK_R_BRACKET;
        case A::LCURL: return B::TOK_L_BRACE;
        case A::RCURL: return B::TOK_R_BRACE;
        case A::LT: return B::TOK_L_ANGLE;
        case A::GT: return B::TOK_R_ANGLE;
        // Note: SHR is no longer a lexer token (>> is two GT tokens)
        case A::LPAR: return B::TOK_L_PAREN;
        case A::RPAR: return B::TOK_R_PAREN;
        case A::LOG_NOT: return B::TOK_NOT;
        case A::COLON: return B::TOK_COLON;
        case A::COMMA: return B::TOK_COMMA;
        case A::QUESTION: return B::TOK_QUESTION;
        case A::DOT: return B::TOK_DOT;
        case A::ASSIGN: return B::TOK_ASSIGN;
        case A::SEMICOLON: return B::TOK_SEMICOLON;
        case A::AT: return B::TOK_AT;
        case A::PP: return B::TOK_PP;
        case A::DONTCARE: return B::TOK_DONTCARE;
        case A::MASK: return B::TOK_MASK;
        case A::DOTS: return B::TOK_DOTS;
        case A::RANGE: return B::TOK_RANGE;
        // Literals
        case A::IDENTIFIER: return B::TOK_IDENTIFIER;
        case A::STRING_LITERAL: return B::TOK_STRING_LITERAL;
        case A::INTEGER: return B::TOK_INTEGER;
        default: return B::TOK_UNEXPECTED_TOKEN;
    }
}
...
/// Helper: create an AnnotationToken from an ANTLR4 terminal, mapping its
/// token type to the Bison equivalent expected by P4AnnotationLexer.
P4::IR::AnnotationToken *P4IRConstructor::makeAnnotationToken(antlr4::Token *token) {
    int bisonType = antlr4ToBisonTokenType(token->getType());
    auto text = P4::cstring(token->getText());
    // For IDENTIFIER tokens, check if the identifier refers to a type.
    // The Bison annotation re-parser needs TYPE_IDENTIFIER for proper
    // type member access (e.g., EnumType.VALUE).
    if (token->getType() == ::P4Lexer::IDENTIFIER) {
        auto kind = structure->lookupIdentifier(text);
        if (kind == P4::Util::ProgramStructure::SymbolKind::Type ||
            kind == P4::Util::ProgramStructure::SymbolKind::TemplateType) {
            bisonType = P4::P4Parser::token_type::TOK_TYPE_IDENTIFIER;
        }
    }
    auto *annToken = new P4::IR::AnnotationToken(srcInfo(token), bisonType, text);
    // For INTEGER tokens, set constInfo for the Bison annotation re-parser.
