...
public:
  ...
  enum {
    RuleProgram = 0, RuleDeclaration = 1, RuleNonTypeName = 2, RuleName = 3, 
    RuleNonTableKwName = 4, RuleAnnotationName = 5, RuleOptAnnotations = 6, 
    RuleAnnotations = 7, RuleAnnotation = 8, RuleAnnotationBody = 9, RuleAnnotationToken = 10, 
    RuleOptTrailingComma = 11, RuleParameterList = 12, RuleNonEmptyParameterList = 13, 
    RuleParameter = 14, RuleDirection = 15, RuleTypeRef = 16, RuleNamedType = 17, 
    RulePrefixedType = 18, RuleTypeName = 19, RuleP4listType = 20, RuleTupleType = 21, 
    RuleSpecializedType = 22, RuleBaseType = 23, RuleTypeOrVoid = 24, RuleOptTypeParameters = 25, 
    RuleTypeParameters = 26, RuleTypeParameterList = 27, RuleTypeArg = 28, 
    RuleTypeArgumentList = 29, RuleRealTypeArg = 30, RuleRealTypeArgumentList = 31, 
    RuleTypeDeclaration = 32, RuleDerivedTypeDeclaration = 33, RuleHeaderTypeDeclaration = 34, 
    RuleStructTypeDeclaration = 35, RuleHeaderUnionDeclaration = 36, RuleStructFieldList = 37, 
    RuleStructField = 38, RuleEnumDeclaration = 39, RuleSpecifiedIdentifierList = 40, 
    RuleSpecifiedIdentifier = 41, RuleErrorDeclaration = 42, RuleMatchKindDeclaration = 43, 
    RuleIdentifierList = 44, RuleTypedefDeclaration = 45, RulePackageTypeDeclaration = 46, 
    RuleParserDeclaration = 47, RuleParserTypeDeclaration = 48, RuleParserLocalElements = 49, 
    RuleParserLocalElement = 50, RuleParserStates = 51, RuleParserState = 52, 
    RuleParserStatements = 53, RuleParserStatement = 54, RuleParserBlockStatement = 55, 
    RuleTransitionStatement = 56, RuleStateExpression = 57, RuleSelectExpression = 58, 
    RuleSelectCaseList = 59, RuleSelectCase = 60, RuleKeysetExpression = 61, 
    RuleTupleKeysetExpression = 62, RuleSimpleExpressionList = 63, RuleReducedSimpleKeysetExpression = 64, 
    RuleSimpleKeysetExpression = 65, RuleValueSetDeclaration = 66, RuleControlDeclaration = 67, 
    RuleControlTypeDeclaration = 68, RuleControlLocalDeclarations = 69, 
    RuleControlLocalDeclaration = 70, RuleControlBody = 71, RuleExternDeclaration = 72, 
    RuleMethodPrototypes = 73, RuleFunctionPrototype = 74, RuleMethodPrototype = 75, 
    RuleInstantiation = 76, RuleOptObjInitializer = 77, RuleObjDeclarations = 78, 
    RuleObjDeclaration = 79, RuleOptConstructorParameters = 80, RuleTableDeclaration = 81, 
    RuleTablePropertyList = 82, RuleTableProperty = 83, RuleOptCONST = 84, 
    RuleKeyElementList = 85, RuleKeyElement = 86, RuleActionList = 87, RuleActionRef = 88, 
    RulePrefixedNonTypeName = 89, RuleEntry = 90, RuleEntryPriority = 91, 
    RuleEntriesList = 92, RuleActionDeclaration = 93, RuleVariableDeclaration = 94, 
    RuleVariableDeclarationWithoutSemicolon = 95, RuleConstantDeclaration = 96, 
    RuleDeclarator = 97, RuleOptInitializer = 98, RuleInitializer = 99, 
    RuleFunctionDeclaration = 100, RuleArgumentList = 101, RuleNonEmptyArgList = 102, 
    RuleArgument = 103, RuleExpressionList = 104, RuleKvList = 105, RuleKvPair = 106, 
    RuleStatement = 107, RuleAssignmentOrMethodCallStatement = 108, RuleEmptyStatement = 109, 
    RuleExitStatement = 110, RuleReturnStatement = 111, RuleConditionalStatement = 112, 
    RuleBreakStatement = 113, RuleContinueStatement = 114, RuleDirectApplication = 115, 
    RuleBlockStatement = 116, RuleStatOrDeclList = 117, RuleStatementOrDeclaration = 118, 
    RuleSwitchStatement = 119, RuleSwitchCases = 120, RuleSwitchCase = 121, 
    RuleSwitchLabel = 122, RuleForStatement = 123, RuleForInitStatements = 124, 
    RuleDeclOrAssignmentOrMethodCallStatement = 125, RuleAssignmentOrMethodCallStatementWithoutSemicolon = 126, 
    RuleForUpdateStatements = 127, RuleForCollectionExpr = 128, RuleLvalue = 129, 
    RuleExpression = 130, RuleNonBraceExpression = 131
  };
